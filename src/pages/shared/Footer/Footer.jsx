        ...
        <footer className="footer footer-horizontal footer-center bg-neutral text-neutral-content p-10">
            ...
            <nav>
                <div className="grid grid-flow-col gap-4">
                    {/* FACEBOOK */}
                    <a
                        href="https://www.facebook.com/people/Technology-Evolution-Portal/61584122595143/"
                        target="_blank"
                    ...
                    {/* TWITTER / X */}
                    <a
                        href="https://x.com/technevoportal"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <svg
                        ...
                        >
                            ...
                            -3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 
                            0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165
                            -10.148-5.144-1.29 2.213-.669 5.108 1.523 
                            6.574-.806-.026-1.566-.247-2.229-.616-.054 
                            2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232
                    ...
                    {/* YOUTUBE */}
                    <a
                        href="https://www.youtube.com/channel/UCKf82_ZTpN-IDMQT_uqPDWQ"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <svg
